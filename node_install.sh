...
solana create-vote-account -v --commission 100 -k ~/solana/validator-keypair.json \
~/solana/vote-account-keypair.json ~/solana/validator-keypair.json ~/solana/validator-keypair(withdrawer).json
